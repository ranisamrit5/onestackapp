...
import Search1Component from './Search1Component';
import { Navigation, Images } from '../../../../utils/theme';
const Search1Containor = (props) => {
    ...
    const go = () => {
        navigation.navigate('SearchContainor')
      };
...
export default connect(mapStateToProps, mapDispatchToProps)(Search1Containor);
